...
import mp3player.mp3.Mp3Player;
...
public class MainController implements Initializable {
    ...
    private void configureMenu() {
        ...
        MenuItem aboutMenuItem = menuPaneController.getAboutMenuItem();
        MenuItem closeMenuItem = menuPaneController.getCloseMenuItem();
        ...
        aboutMenuItem.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                Parent parent = null;
                try {
                    URL url = new File("src/mp3player/view/AboutPane.fxml").toURI().toURL();
